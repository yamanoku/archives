...
デザインシステムが間違った方向のまま進んでしまうと、結果として悪いものを生んでしまいかねません。デザインによっては人を傷つけたり、ある層を排除することもできてしまうので、自分たちのプロダクトは<strong>何を目的としているのか？どのような未来を描こうとしているのか？</strong>といった視点を持つことも忘れてはいけません。
